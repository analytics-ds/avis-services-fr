...
- **Nom du site** : Avis Services
- **Description (FR)** : Avis et comparatifs de services en ligne : electromenager reconditionne, spa de luxe et bien plus.
- **Description (EN)** : Reviews and comparisons of online services: refurbished appliances, luxury spas and more.
- **URL** : https://avis-services.fr/ (a activer via `/github-setup`)
- **Couleurs** :
  - Primary : #1E40AF (bleu confiance)
  - Primary-light : #3B82F6
  - Primary-dark : #1E3A8A
  - Accent : #F59E0B (orange etoile review)
  - CTA : #2563EB (bleu vif)
  - Background : #FFFFFF
  ...
  - Border : #E5E7EB
- **Polices** :
  - Titres : Playfair Display (serif, magazine)
  - Corps + UI : Inter (sans-serif, lisible)
- **Langue principale** : FR (la version EN en sous-dossier `/en/` est active)
- **Categories (FR ↔ EN)** :
  - Electromenager reconditionne / Refurbished appliances
  - Spa de luxe / Luxury spas
- **Auteur principal du site** : `thomas-durand` (tech/electromenager) et `laura-verdier` (sante/bien-etre, pour les spa). `/create-article-geo` selectionne automatiquement selon le sujet ; par defaut `thomas-durand`.
- **Positionnement editorial** : media B2C d'avis et comparatifs independants sur des services et produits du quotidien.
