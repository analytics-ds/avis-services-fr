...
- **Auteur principal du site** : `thomas-durand` (tech/electromenager) et `laura-verdier` (sante/bien-etre, pour les spa). `/create-article` selectionne automatiquement selon le sujet ; par defaut `thomas-durand`.
